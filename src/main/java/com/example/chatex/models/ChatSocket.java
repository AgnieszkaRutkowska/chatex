package com.example.chatex.models;
...
public class ChatSocket extends TextWebSocketHandler implements WebSocketConfigurer {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
      ...
      // session.sendMessage(new TextMessage("Twoja piersza wiadomość, będzie Twoim nickiem"));

       session.sendMessage(new TextMessage("<server>Twoja piersza wiadomość, będzie Twoim nickiem"));
    }
